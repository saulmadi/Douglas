...
using Douglas.EmailClients.DotNet;
using AcklenAvenue.Commands;
using Douglas.TemplateEngines.Razor;
using Douglas.Web.Api.emails;
using Douglas.Web.Api.Infrastructure.Authentication;
using Douglas.Web.Api.Infrastructure.Authentication.Roles;
